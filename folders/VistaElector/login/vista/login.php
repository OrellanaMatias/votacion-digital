...
if(isset($_POST['dni'])) {
    ...
    $currentCiudadano = $ciudadano->getCiudadanoByDni($_POST['dni']);
...
<div class="pricing-header pt-md-5 pb-md-4 mx-auto text-center">
    <h1 class="display-5">Introducir su documento de identidad.</h1>
</div>
    ...
    <div class="col-md-3">
        ...
        <form action="login.php" method="POST">
            <div class="form-group">
                <input type="text" class="form-control" id="documento" name="dni" required placeholder="Ingrese su DNI">
