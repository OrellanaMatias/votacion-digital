            ...
            <div class="col-md-2">
                <div class="card" style="width: 14rem;">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-2 text-muted"><?= $post->dni; ?><hr><br><?= $post->email; ?></h6>
                        <hr>
                        <br>
                        <?php if ($post->estado == 1) : ?>
                            <a href="../servicios/desactivarCiudadano.php?dni=<?= $post->dni; ?>" class="btn btn-danger">Desactivar</a>
                        <?php else : ?>
                            <a href="../servicios/activarCiudadano.php?dni=<?= $post->dni; ?>" class="btn btn-dark">Activar</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
